...
<div id="laporan">
<table align="center" style="width:180px; border-bottom:3px double;border-top:none;border-right:none;border-left:none;margin-top:5px;margin-bottom:10px; text-align:center;font-size: 12px;">
<tr>
    <!-- <td><img src="<?php// echo base_url().'assets/img/kop_surat.png'?>"/></td> -->
</tr>
<tr>
    <td style="font-size: 13px;"><b>UD. Bali Cipta Seni</b></td>
</tr>
<tr>
    <td>Art Materials Specialist</td>
</tr>
<tr>
